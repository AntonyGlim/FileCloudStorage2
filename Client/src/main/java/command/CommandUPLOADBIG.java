...
//
//public class CommandUPLOADBIG  implements Command {
//    @Override
...
//            ConnectionManager.getConnectionManager(null).send(new Message(MessageType.UPLOAD_BIG_FILE, sourcePath.toFile()));
